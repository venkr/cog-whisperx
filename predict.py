...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        diarize: bool = Input(description="Include speaker diarization", default=True),
        ...
        with torch.inference_mode():
            ...
            # segments is a list of dicts,each dict has {'text': <text>, 'start': <start_time_msec>, 'end': <end_time_msec> }
                ...
                #result = whisperx.align(result['segments'], self.alignment_model, self.metadata, audio, self.device, return_char_alignments=False)
            ...
            if diarize:
                ...
                # merge diarization segments with text segments
